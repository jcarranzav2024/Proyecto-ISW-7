...
-- AddForeignKey
ALTER TABLE `Curso` ADD CONSTRAINT `Curso_OfertaAcademicaId_fkey` FOREIGN KEY (`OfertaAcademicaId`) REFERENCES `OfertaAcademica`(`OfertaAcademicaId`) ON DELETE SET NULL ON UPDATE CASCADE;
